...
### **Phase 2: Timeline + Feelings + Onboarding ⏳ IN PROGRESS**
- ⬜ Data model migration (meals → timeline)
- ⬜ Migration script (convert existing data)
- ⬜ Timeline display in TodayView
- ⬜ Feeling logging UI (multi-select, categories)
- ⬜ Flexible time granularity (after meal / time of day / specific)
- ⬜ Onboarding flow (welcome + how it works + example)
- ⬜ Empty states (TodayView, Library, Stats)

**Target completion:** Week of March 13, 2026

---

### **Phase 3: Stats MVP ⏳ NOT STARTED**
- ⬜ Overview stats (days logged, meals, unique items, streak)
- ⬜ Top 10 foods/drinks (7/30/90 days, all time)
- ⬜ Last eaten dates (clickable → jump to day)
...
**Current Phase:** Phase 1 complete. Starting Phase 2 (Timeline + Feelings + Onboarding).
**Timeline:** 6 weeks to production-ready MVP (target: mid-April 2026)
**Next Milestone:** Timeline model migration (Week of March 13)
